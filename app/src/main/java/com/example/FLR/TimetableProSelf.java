...
public class TimetableProSelf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result_search_pro = ((SecondActivity) SecondActivity.context_second).result_search_pro;
        ...
        String professorName = ((MainActivity) MainActivity.context_main).Pro_Name;
        mName = (TextView)findViewById(R.id.name);
        mName.setText(professorName);
