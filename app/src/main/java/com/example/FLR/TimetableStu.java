...
public class TimetableStu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result_search_stu = ((SecondActivity) SecondActivity.context_second).result_search_stu;
        Log.d("result_search_Timetable", result_search_stu);

        if (result_search_stu != null) { //받아온 json값이 널이면

            mJsonString = result_search_stu; //json 값을 mJsonString 변수에 넣고
